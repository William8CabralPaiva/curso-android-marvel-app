    ...
    override suspend fun load(
        ...
        return try {
            ...
            database.withTransaction {
                ...
                remoteKeyDao.insertOrReplace(RemoteKey(nextOffset = responseOffset + state.config.pageSize))

                val characterEntity = characterPaging.characters.map {
                    CharacterEntity(
                        id = it.id,
                        name = it.name,
            ...
            //pra não ficar carregando a pagina sem para quando chegar no fim da paginação
